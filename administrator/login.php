...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../assets/assets/img/profile-jurusan/<?= $resultProfilePk['foto']?>" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-uppercase text-body fw-bolder">PSPTV</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Log In</h4>
              <p class="mb-4">Mohon harap login terlebih dahulu</p>

              <form id="formAuthentication" class="mb-3" method="POST">
                <div class="mb-3">
                  <label for="usernamw" class="form-label">Username</label>
                  <input
                    type="text"
                    class="form-control"
                    id="username"
              ...
              <p class="text-center">
                <a href="register">
                  <span>Create an member account</span>
                </a>
              </p>
            </div>
          </div>
